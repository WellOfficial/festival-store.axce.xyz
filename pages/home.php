...
<div class="container mt-3">
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-none d-lg-block">
                <div class="row mt-3">
                    <div class="col-4 mt-2">
                        <div class="card">
                            <div class="card-body bg-white text-center">
                                <h1 class="mt-0 mb-0" style="font-size: 3.5rem; color:Gray;"><i class="fas fa-gamepad"></i></h1>
                                <h1 class="mt-0 mb-0" style="color:Gray;"><?php echo $allproduct['total']; ?></h1>
                    ...
                    <div class="col-4 mt-2">
                        <div class="card">
                            <div class="card-body bg-white text-center">
                                <h1 class="mt-0 mb-0" style="font-size: 3.5rem; color:Gray;"><i class="fas fa-check-circle"></i></h1>
                                <h1 class="mt-0 mb-0" style="color:Gray;"><?php echo $soldproduct['total']; ?></h1>
                    ...
                    <div class="col-4 mt-2">
                        <div class="card">
                            <div class="card-body bg-white text-center">
                                <h1 class="mt-0 mb-0" style="font-size: 3.5rem; color:Gray;"><i class="fas fa-shopping-basket"></i></h1>
                                <h1 class="mt-0 mb-0" style="color:Gray;"><?php echo $readyproduct['total']; ?></h1>
            ...
            <div class="mt-3">
                <h2 class="text-center" style="color:Gray;">บริการอื่นๆ</h2>
            </div>
            <div class="row mt-3">
                <?php if(empty($show_card_other)){ ?>
                    <div class="col-12 mt-2 text-center" style="color:Gray;">
            ...
            <div class="mt-3">
                <h2 class="text-center" style="color:Gray;">สินค้าล่าสุด</h2>
            </div>
            <div class="row">
                <?php if(empty($show_card_productlimit)){ ?>
                    <div class="col-12 mt-2">
                        <h3 class='text-center' style="color:Gray;">ไม่มีสินค้า ณ ขณะนี้</h3>
                    </div>
                <?php } ?>
