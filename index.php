...
<body>
    ...
    ?>
    <div class="container">
        <div class="mb-2 justify-content-center text-center text-dark">
        <i class="fas fa-copyright"></i> Made with <i class="fas fa-heart text-danger"></i> By <a href="https://twitter.com/AyakiLunar_" class="text-dark" style="text-decoration: none;">Ayaki Lunar</a> | Powered by <a href="https://rdcw.in.th" class="text-dark" style="text-decoration: none;">RDCW</a> 2021 - 2022
        <br>Icon By flaticon.com & fontawesome.com
        <br><img src="https://cdn.discordapp.com/attachments/887754573014528010/1010227258054672484/wpg.png" class="img-fluid mt-2" style="height:60px;" alt="Webshop Providers Group" title="RDCW is a member of Webshop Providers Group">
        <p class="small text-muted mt-2 mb-0">
        <a class="text-decoration-none text-muted small" href="https://fb.me/rdcw.in.th/"> ติดต่อร้านค้าไม่ได้ / ต้องการรายงานปัญหาร้านค้าฉ้อโกง?</a>&nbsp;
        </p>
        </div>
    </div>
</body>
